...
export default {
  ...
  translation: {
    common: {
      ...
      background: 'Ảnh nền',
      baseCustomFields_title: 'Các trường tùy chỉnh gốc',
      baseGroup: 'Nhóm gốc',
      board: 'Bảng',
      ...
      fullKeyIsHiddenForSecurityReasons:
        'Key đầy đủ bị ẩn vì lý do bảo mật. Hãy tạo lại để có key mới.',
      general: 'Chung',
      ...
      noConnectionToServer: 'Mất kết nối',
      ...
      role: 'Vai trò',
      saveThisKeyItWillNotBeShownAgain: 'Hãy lưu lại key này — key sẽ không được hiển thị lại!',
      ...
      userActions_title: 'Thao tác của người dùng',
      userAddedCardToList: '<0>{{user}}</0> đã thêm thẻ <2>{{card}}</2> trong danh sách {{list}}',
      userAddedThisCardToList: '<0>{{user}}</0> đã thêm thẻ này vào danh sách {{list}}',
      userAddedUserToCard: '<0>{{actorUser}}</0> đã thêm {{addedUser}} vào thẻ <4>{{card}}</4>',
      userAddedUserToThisCard: '<0>{{actorUser}}</0> đã thêm {{addedUser}} vào thẻ này',
      userAddedYouToCard: '<0>{{user}}</0> đã thêm bạn vào thẻ <2>{{card}}</2>',
      userCompletedTaskOnCard: '<0>{{user}}</0> đã hoàn thành {{task}} của thẻ <4>{{card}}</4>',
      userCompletedTaskOnThisCard: '<0>{{user}}</0> đã hoàn thành {{task}} của thẻ này',
      userJoinedCard: '<0>{{user}}</0> đã tham gia thẻ <2>{{card}}</2>',
      userJoinedThisCard: '<0>{{user}}</0> đã tham gia thẻ này',
      userLeftCard: '<0>{{user}}</0> đã rời khỏi thẻ <2>{{card}}</2>',
      userLeftNewCommentToCard:
        '<0>{{user}}</0> đã để lại bình luận mới «{{comment}}» trong thẻ <2>{{card}}</2>',
      userLeftThisCard: '<0>{{user}}</0> đã rời khỏi thẻ này',
      userMarkedTaskIncompleteOnCard:
        '<0>{{user}}</0> đã đánh dấu {{task}} là chưa hoàn thành trong thẻ <4>{{card}}</4>',
      userMarkedTaskIncompleteOnThisCard:
        '<0>{{user}}</0> đã đánh dấu {{task}} là chưa hoàn thành trong thẻ này',
      userMentionedYouInCommentOnCard:
        '<0>{{user}}</0> đã nhắc đến bạn trong một bình luận «{{comment}}» của thẻ <2>{{card}}</2>',
      userMovedCardFromListToList:
        '<0>{{user}}</0> đã di chuyển thẻ <2>{{card}}</2> từ danh sách {{fromList}} sang danh sách {{toList}}',
      userMovedThisCardFromListToList:
        '<0>{{user}}</0> đã di chuyển thẻ này từ danh sách {{fromList}} sang danh sách {{toList}}',
      userRemovedUserFromCard: '<0>{{actorUser}}</0> đã xóa {{removedUser}} khỏi thẻ <4>{{card}}</4>',
      ...
      withoutBaseGroup: 'Không kèm nhóm gốc',
    ...
    action: {
      ...
      restoreToList: 'Khôi phục vào danh sách {{list}}',
